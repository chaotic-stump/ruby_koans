...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject adds a specified number to the array and continues the looped functions like it was originally part of the array.
  end
  ...
  #   # code to read 'file'
  #
  # This was mostly for readability. Either way would work, but setting it  
  # in a block communicates more clearly when you are done with the file.
  # 
